...
public class WarehouseGoodsPk implements Comparable<WarehouseGoodsPk>, Serializable {
    ...
    public WarehouseGoodsPk(Integer typeOfGoodsId, Integer warehouseId) {
    ...
    public boolean areFieldsSet() {
        return isTypeOfGoodsIdSet() && isWarehouseIdSet();
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(getTypeOfGoodsId(), //
                getWarehouseId());
    }
    ...
    */
    ...
    public static WarehouseGoodsPk fromString(String string) {
        ...
        if (isNotEmpty(values[0])) {
            result.setTypeOfGoodsId(Integer.valueOf(values[0]));
        }
