...
public class BookDTOService {
    ...
    public PageResponse<BookDTO> findAll(PageRequestByExample<BookDTO> req) {
        ...
        if (book != null) {
            ExampleMatcher matcher = ExampleMatcher.matching() //
                    .withMatcher(Book_.extractContentType.getName(), match -> match.ignoreCase().startsWith())
                    .withMatcher(Book_.extractFileName.getName(), match -> match.ignoreCase().startsWith())
    ...
    public BookDTO save(BookDTO dto) {
        ...
        book.setExtractBinary(dto.extractBinary);

        book.setExtractContentType(dto.extractContentType);

        book.setExtractFileName(dto.extractFileName);

        book.setExtractSize(dto.extractSize);
    ...
    public BookDTO toDTO(Book book, int depth) {
        ...
        dto.extractBinary = book.getExtractBinary();
